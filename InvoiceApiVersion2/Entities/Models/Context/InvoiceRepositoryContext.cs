...
{
    public partial class InvoiceRepositoryContext : DbContext
    {
        public InvoiceRepositoryContext()
        {
        }

        public InvoiceRepositoryContext(DbContextOptions<InvoiceRepositoryContext> options)
            : base(options)
        {
        }
